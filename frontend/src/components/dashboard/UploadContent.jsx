import { Upload, FileText, Trash2, Download, Eye, FileSearch } from 'lucide-react';
...
const UploadContent = () => {
    ...
    const { setProjectData, setActiveTab } = useContext(AppContext);
                ...
                <motion.div className="mt-8" {...fadeInUp}>
                    ...
                    <div className="space-y-3">
                        {documents.map((doc, index) => (
                            <motion.div
                                key={index}
                                className={`flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600 hover:shadow-md transition-all duration-200 ${deletingDocId === doc._id ? 'opacity-50' : ''}`}
                                {...listItem(index)}
                            >
                                ...
                                <div className="flex items-center gap-2">
                                    <motion.button
                                        ...
                                        className="text-greene-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors duration-200 p-2 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg group disabled:opacity-50 disabled:cursor-not-allowed"
                                        {...hoverScale}
                                    >
